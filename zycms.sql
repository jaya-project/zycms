...
(3, 'admin', '96748968da17ca098c06cc53c4e087d0196cbdde', '2015-06-23 14:20:43', 1, 8),
(4, 'jaya', 'd033e22ae348aeb5660fc2140aec35850c4da997', '2015-06-27 14:19:47', 1, 6);
...
CREATE TABLE IF NOT EXISTS `zycms_ad_position` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='广告位表' AUTO_INCREMENT=3 ;
...
CREATE TABLE IF NOT EXISTS `zycms_archives` (
  ...
  PRIMARY KEY (`id`),
  KEY `cid` (`cid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='文章主表' AUTO_INCREMENT=6 ;

--
-- 转存表中的数据 `zycms_archives`
--

INSERT INTO `zycms_archives` (`id`, `title`, `sub_title`, `tag`, `thumb`, `seo_title`, `abstract`, `seo_keywords`, `seo_description`, `create_time`, `author`, `source`, `sort`, `click_count`, `recommend_type`, `cid`, `sub_column`, `is_delete`, `delay_time`) VALUES
(1, 'pro1', '这是副标题', '', '', '', '这是文章摘要', '', '', 1449813556, 'admin', '原创', 50, 0, 'c,h', 1, '5', 0, 0),
(2, 'Pro2', '这是副标题', '', '', '', '这是文章摘要,,,,', '', '', 1449813624, 'admin', '原创', 50, 0, 'c,h', 1, '', 0, 0),
(3, 'news1', '', '', '', '', '', '', '', 1449813736, 'admin', '原创', 50, 0, '', 2, '3,4,7,8,9', 0, 0),
(4, 'news2_faq', '', '', '', '', '这是文章摘要', '', '', 1449813921, 'admin', '原创', 50, 0, 'c,h', 2, '3,4', 0, 0),
(5, '职位名称', '', '', '', '', '', '', '', 1450751290, 'admin', '原创', 50, 0, '', 10, '', 0, 0);
...
(3, '<div class="end-text" id="endText">\n<p>有消息称，首款由谷歌全权操刀打造的平板电脑Google&nbsp;Pixel&nbsp;C本周四突然在香港Google商店上架，专属的磁吸式&nbsp;Pixel&nbsp;C键盘售价为HK$1,188且需要另外订购。尽管暂时只有定价&nbsp;HK$3,888（约人民币&nbsp;3,200&nbsp;元）的32GB&nbsp;版本，但想到可以提前体验这款个性平板还是挺激动人心的。</p>\n\n<p style="text-align:center;"><br clear="all" />\n<img alt="谷歌Google Pixel C香港开卖HK$3,888起" src="http://img1.cache.netease.com/catchpic/B/BE/BE12C5E53BF39985AF8E258639568FBA.jpg" /><br />\n<strong>谷歌Pixel&nbsp;C（图源：engadget）</strong></p>\n\n<p>据悉，这款全新设计的Google&nbsp;Pixel&nbsp;C配置方面还是比较不错的，预装Android&nbsp;6.0&nbsp;Marshmallow操作系统，配备10.2英寸2,560X1800的高分辨率屏幕，搭载NVIDIA&nbsp;Tegra&nbsp;X1处理器及3GB&nbsp;LDDR4&nbsp;RAM内存，还配有800万像素后置摄像头及200万像素前置摄像头，机身配有USB&nbsp;Type-C&nbsp;接口和双频&nbsp;MIMO&nbsp;Wi-Fi接口，有了高配置相信体验感也会更不一样，但是这款平板随机仅标配一个USB&nbsp;Type-C充电器，需要自行配备Type-A及Type-C接线来实现与电脑或其他设备的链接，这一点估计要被用户们吐槽了。</p>\n\n<p style="text-align:center;"><img alt="谷歌Google Pixel C香港开卖HK$3,888起" src="http://img1.cache.netease.com/catchpic/7/75/759FF1E78AABE9F225AE1BD475A11EC2.jpg" /><br />\n<strong>谷歌Pixel&nbsp;C<strong style="text-align:center;">（图源：engadget）</strong></strong></p>\n\n<p>&nbsp;</p>\n\n<div class="gg200x300">&nbsp;</div>\n\n<p>早前，谷歌Pixel&nbsp;C已经于美国当地时间12月8日正式登陆谷歌商店，包括14个国家和地区的用户可以购买。价格方面，该机32GB和64GB容量版本的价格分别为499美元和599美元，约合人民币3200元及3840元左右。</p>\n\n<p>据了解，在香港Google商店上架的Google&nbsp;Pixel&nbsp;C，下单后1至2个工作天内出货，算上键盘还要加钱，因此要体验全套Pixel&nbsp;C，最少要付出&nbsp;HK$5,076，相比跟Surface&nbsp;Pro&nbsp;4同样的定价方式，不知道大家的内心是拒绝的还是疯狂的。</p>\n\n<div class="ep-source cDGray"><span class="left"><a href="http://digi.163.com/"><img alt="netease" class="icon" height="12" src="http://img1.cache.netease.com/cnews/css13/img/end_digi.png" width="13" /></a> 本文来源：中关村在线 </span></div>\n</div>\n'),
(4, '<div class="end-text" id="endText">\n<p class="f_center"><img alt="系列报道(1)：智能音箱会成下一个“手机”吗？" src="http://img3.cache.netease.com/tech/2015/12/11/20151211091227ded54.jpg" /></p>\n\n<p><font face="楷体,楷体_GB2312">编者按：继可穿戴系列报道《手腕上的智能革命》之后，网易开物推出第二季系列报道《那些载乐逐歌的精灵》，聚焦&ldquo;智能音乐设备&rdquo;。我们将关注智能耳机、智能音箱、智能乐器等智能音乐设备领域，挖掘音乐内容与互联网、智能设备碰撞的存在形态和发展方向。</font></p>\n\n<p><font face="楷体,楷体_GB2312">另外，由网易科技与网易云音乐共同主办的第2期开物沙龙将于12月20日（周日）下午14点在北京中关村创业大街极客咖啡举行。现场将会有智能音乐领域的大咖登场，还有智能音箱等奖品等你拿！12月14日开启线上报名，敬请关注<b><a href="http://tech.163.com/smart/">网易智能硬件频道</a></b>，不要错过哦。</font></p>\n\n<p><font face="楷体,楷体_GB2312">文/李儒超</font></p>\n\n<p>从诞生那刻起，智能音箱似乎就与爆品无缘。</p>\n\n<p>这个几乎与智能硬件概念被提出同时的细分领域，哪怕在所谓的&ldquo;资本寒冬&rdquo;期，也并未缺过新入局者。无论是互联网团队，还是设计团队，抑或是传统电声团队等等，不同基因的各路玩家常年充斥其中；与此同时，360、京东、小米等巨头也悄然入局，甚至有人预测，智能音箱有可能成为IOT的入口级产品。</p>\n\n<p>但这显然从未得到过验证。</p>\n\n<p>推出了Shout音箱的Rocklava联合创始人叶燕龙坦言，在智能音箱领域，暂时看不到一款具有压倒性优势的单品，&ldquo;在京东或者天猫上，没有哪款智能音箱卖的特别多，在这个领域谈品牌优势也毫无意义&rdquo;。在他看来，这个现状是智能音箱创业团队难得的机会。</p>\n\n<p>当然，更多的还是挑战。当&ldquo;久红不爆&rdquo;成为常态，智能音箱要何去何从？</p>\n\n<p><b>突破口：为何多是WiFi音箱？</b></p>\n\n<p>如同其他被称作&ldquo;智能&rdquo;的产品一样，智能音箱之所以被称为智能，主要是因为其&ldquo;可联网&rdquo;，而无线音箱所承载的连接特性为智能化提供了土壤。</p>\n\n<p>一位电声行业从业者告诉网易科技，单就无线音箱来说，并不是一个新事物，&ldquo;从2.4G音箱到如今占据主流的蓝牙音箱，再到初见规模的WiFi音箱，无线音箱一直在演变&rdquo;。</p>\n\n<p>不过，作为一种点对点的连接方式，蓝牙似乎并不能满足音箱创业者的野心。方糖音箱创始人宋少鹏表示，虽然蓝牙和有线依旧是整个音箱界的主流，但音箱的未来一定是wifi音箱。</p>\n\n<p>而近两年的音箱创业项目中，据网易科技对其中30余款进行不完全统计，WiFi音箱占据整个智能音箱项目的七成以上。之所以大多选择从wifi音箱突破，根据多位从业者叙述，网易科技将其具备的主要特点整理如下：</p>\n\n<p>1、Wifi传输速率一般在150Mbps以上，相比之下蓝牙仅有2Mbps，在传输高音质音源时，WiFi音箱具备较大优势，尤其在音乐平台越来越推崇高音质音源的现状下；</p>\n\n<p>2、WiFi传播距离在没有墙的阻隔下可达30米以上，在传播距离以及穿透性能上好于传播距离仅为10米的蓝牙；</p>\n\n<p>3、WiFi音箱由于可直接联网，可作为独立设备播放音乐，而蓝牙音箱必须与音源设备如手机连接才能正常使用，这在很大程度上降低了使用便捷性。</p>\n\n<p>在这其中，高音质和独立性使得智能音箱脱离传统音箱设备，具备了更大的想象空间。这也是当前选择音箱创业的团队大多将WiFi作为其卖点的重要原因。</p>\n\n<p><b>消费习惯和售价掣肘</b></p>\n\n<p>&nbsp;</p>\n\n<p>然而事实是，即便具有一定优势，WiFi音箱的市场认知度并不高。</p>\n\n<p>叶燕龙表示，根据他们掌握的数据，目前WiFi音箱在无线音箱市场的市占率大约只有10%，蓝牙则几乎占据了剩下的份额。究其因，主要是消费习惯尚未转变以及价格问题。</p>\n\n<p>据了解，作为一款以线下渠道为主的品类，消费者对音箱的认知转变相对缓慢，以WiFi音箱为主力的智能音箱尚未普及到大众消费者。&ldquo;一个较为有趣的现象是，不少智能音箱团队在制作宣传文案时会特意标注能实现大半、百分之90、几乎所有蓝牙音箱功能之类的字眼&rdquo;，一位从业人士表示。</p>\n\n<p>同时，虽然WiFi模块已经较为成熟，但通常造价不菲，一些加了显示屏、触摸屏的设备则更加昂贵。据网易科技了解，在蓝牙音箱中200元以下的产品占据了大部分市场，在WiFi音箱中则相反，200元以下的设备十分难觅，1000元以上的产品目前是该领域的主流。</p>\n\n<p>这两方面也注定了智能音箱短时间内很难成为大众消费品市场的宠儿。</p>\n\n<p>&ldquo;不过值得欣喜的是，WiFi音箱市场的增长速度大概是每年30%&rdquo;，叶燕龙说，无论是认知度还是成本问题都在逐步解决，诸如Rocklava在推出了第一款1499元的音箱后，接下来就准备推出一款相对便宜的产品以扩大市场份额。</p>\n\n<p>在认知度方面，由于入局者的逐渐增加，同时WiFi音箱在线下店也在逐步扩张，其便捷性也在逐步为消费者所知。叶燕龙坦言，智能音箱市场在久红不爆的情况下还有持续不断的新厂商进来，主要源于厂商们对未来的预期。</p>\n\n<p><b>入口级硬件？</b></p>\n\n<p>&nbsp;</p>\n\n<p>值得强调的是，这个预期除了来自于销量，还有不少来自于后续的生态级服务。</p>\n\n<p>事实上，基于高音质和独立性的特点，智能音箱有能力作为一款独立入口级产品承载更多的服务职能。然而与诸如手机、电视等其他入口级产品不同，&ldquo;音箱的市场规模相对小，更重要的是，频次不高&rdquo;，宋少鹏坦言，这些特点使得音箱的想象力整体弱于现有入口级产品。</p>\n\n<p>但毕竟智能音箱在音频场景上具备一定优势，一些互联网音频平台觊觎多时。据业内人士透露，至少在今年，已有多家音乐服务提供商、FM有意进军音箱硬件，不过大多还在筹备或受供应链因素搁浅的状态。</p>\n\n<p>与此同时，这些互联网平台在推出自有硬件前，已经与不少音箱厂商达成了内容合作，甚至如蜻蜓FM这样的厂商已经为音箱做了一系列音频内容解决方案。</p>\n\n<p>但观望的依旧不占少数，毕竟暂时还没有案例成功验证行业对音箱产业的预期。</p>\n\n<p>一位FM公司员工告诉网易科技，就当前的市场现状，虽然音箱具有很强的场景针对性，但单纯作为内容分发渠道上看，占比很小。而智能音箱&ldquo;混沌&rdquo;的市场现状，也使得内容提供商难以下注，最终的结果是&ldquo;不少内容方基本是来者不拒的状态，但很少会为某家做专属定制这类深度合作&rdquo;。</p>\n\n<p>对于音箱厂商，大多还致力于拉上更多的内容提供方。由于在分成模式和费用上尚未达成行业共识，这类合作的进展也比预期缓慢一些，相应的，大多数智能音箱团队暂时也无暇考虑尝试更多的服务模式。</p>\n\n<p>然而这并不妨碍&ldquo;音箱生态&rdquo;进入一些厂商的日程中。曾推出小佳音箱的宽洋创始人刘大可则认为，要想将此类产品真正推向大众，建立生态必不可少。</p>\n\n<p>&nbsp;</p>\n\n<div class="gg200x300">&nbsp;</div>\n\n<p>据了解，作为一款带触摸屏的智能音箱，基于安卓的小佳在其平台上上线了100余款APP，其中不乏一些音视频应用。但刘大可也坦言，当前小佳平台的APP体验和丰富度都有待完善，单纯将安卓应用搬到智能音箱上，意义并不大。</p>\n\n<p>&ldquo;基于特定的使用场景，智能音箱还需要想清楚更多可商业化的服务模式&rdquo;，刘大可告诉网易科技。</p>\n\n<p>而在想清楚这个问题前，智能音箱团队们似乎更乐于在音箱交互方式上下功夫。毕竟，在难以强求的内容生态成型前，先做好一个体验不够差的硬件载体，至少可以保证其作为一款普通电子消费品在市场中有所立足。</p>\n\n<div class="ep-source cDGray"><span class="left"><a href="http://tech.163.com/"><img alt="张彬彬" class="icon" height="12" src="http://img1.cache.netease.com/cnews/css13/img/end_tech.png" width="13" /></a> 本文来源：网易科技报道 </span></div>\n</div>\n');
...
(1, '产品', 'a:1:{i:0;a:4:{s:6:"fields";s:4:"body";s:12:"label_fields";s:6:"内容";s:12:"channel_type";s:8:"htmltext";s:6:"values";s:0:"";}}', 'products'),
(2, '文章', 'a:1:{i:0;a:4:{s:6:"fields";s:4:"body";s:12:"label_fields";s:6:"内容";s:12:"channel_type";s:8:"htmltext";s:6:"values";s:0:"";}}', 'article'),
(3, '招聘', 'a:5:{i:0;a:4:{s:6:"fields";s:4:"zwbm";s:12:"label_fields";s:12:"职位部门";s:12:"channel_type";s:4:"text";s:6:"values";s:0:"";}i:1;a:4:{s:6:"fields";s:4:"gzdd";s:12:"label_fields";s:12:"工作地点";s:12:"channel_type";s:4:"text";s:6:"values";s:0:"";}i:2;a:4:{s:6:"fields";s:4:"zprs";s:12:"label_fields";s:12:"招聘人数";s:12:"channel_type";s:4:"text";s:6:"values";s:0:"";}i:3;a:4:{s:6:"fields";s:4:"zgze";s:12:"label_fields";s:12:"工作职责";s:12:"channel_type";s:8:"htmltext";s:6:"values";s:0:"";}i:4;a:4:{s:6:"fields";s:4:"zwyq";s:12:"label_fields";s:12:"职位要求";s:12:"channel_type";s:8:"htmltext";s:6:"values";s:0:"";}}', 'y_job');
...
CREATE TABLE IF NOT EXISTS `zycms_column` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='栏目表' AUTO_INCREMENT=13 ;

--
-- 转存表中的数据 `zycms_column`
--

INSERT INTO `zycms_column` (`id`, `column_name`, `english_name`, `channel_id`, `pid`, `column_thumb`, `summary`, `seo_title`, `seo_keywords`, `seo_description`, `content`, `is_nav`, `sort`, `level`, `rule_type`) VALUES
(1, '产品中心', '', 1, 0, '', '', '', '', '', '', 0, 0, 1, 0),
(2, '新闻资讯', '', 2, 0, '', '', '', '', '', '', 0, 0, 1, 0),
(3, '关于我们', '', 2, 0, '', '', '', '', '', '<p>关于我们关于我们关于我们</p>\n', 0, 0, 1, 0),
(4, '解决方案', '', 2, 0, '', '', '', '', '', '', 0, 0, 1, 0),
(5, '产品一级', '', 1, 1, '', '', '', '', '', '', 0, 0, 2, 0),
(6, '产品一级2', '', 1, 1, '', '', '', '', '', '', 0, 0, 2, 0),
(7, '新闻动态', '', 2, 2, '', '', '', '', '', '', 0, 0, 2, 0),
...
(9, '常见问题', '', 2, 2, '', '', '', '', '', '', 0, 0, 2, 0),
(10, '在线招聘', '', 3, 0, '', '', '', '', '', '', 0, 0, 1, 0),
(11, '在线留言', 'Feedback', 2, 3, '', '', '', '', '', '<p>可在</p>\n\n<p>自定义表单-&gt;表单内容管理-&gt;选择在线留言-&gt;点击 &nbsp;查看表单内容列表中</p>\n\n<p>查看</p>\n', 0, 50, 2, 0),
(12, '产品', '', 1, 1, '', '', '', '', '', '', 0, 0, 2, 2);
...
(1, '在线留言', 'y_message', 'a:7:{i:0;a:3:{s:6:"fields";s:4:"name";s:12:"label_fields";s:12:"姓　　名";s:9:"form_type";s:4:"text";}i:1;a:4:{s:6:"fields";s:4:"unit";s:12:"label_fields";s:12:"留言单位";s:9:"form_type";s:4:"text";s:6:"values";s:0:"";}i:2;a:4:{s:6:"fields";s:7:"address";s:12:"label_fields";s:12:"联系地址";s:9:"form_type";s:4:"text";s:6:"values";s:0:"";}i:3;a:4:{s:6:"fields";s:5:"email";s:12:"label_fields";s:12:"电子邮件";s:9:"form_type";s:4:"text";s:6:"values";s:0:"";}i:4;a:4:{s:6:"fields";s:5:"phone";s:12:"label_fields";s:12:"联系电话";s:9:"form_type";s:4:"text";s:6:"values";s:0:"";}i:5;a:4:{s:6:"fields";s:10:"fax_number";s:12:"label_fields";s:12:"传真号码";s:9:"form_type";s:4:"text";s:6:"values";s:0:"";}i:6;a:4:{s:6:"fields";s:4:"body";s:12:"label_fields";s:12:"留言内容";s:9:"form_type";s:8:"textarea";s:6:"values";s:0:"";}}', '');
...
CREATE TABLE IF NOT EXISTS `zycms_member` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='会员表' AUTO_INCREMENT=6 ;
...
CREATE TABLE IF NOT EXISTS `zycms_opera_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='操作日志表' AUTO_INCREMENT=563 ;
...
(538, -1062731746, 1450751826, 'log@get_data', 'church'),
(539, -1062731746, 1453682171, 'admin@', 'church'),
(540, -1062731746, 1453682173, 'admin@welcome', 'church'),
(541, -1062731746, 1453682182, 'admin@column_add', 'church'),
(542, -1062731746, 1453682184, 'channel@get_model', 'church'),
(543, -1062731746, 1453682184, 'column@get_column', 'church'),
(544, -1062731746, 1453682186, 'column@column_save', 'church'),
(545, -1062731746, 1453682199, 'column@column_save', 'church'),
(546, -1062731746, 1453682241, 'admin@', 'church'),
(547, -1062731746, 1453682243, 'admin@welcome', 'church'),
(548, -1062731746, 1453682244, 'admin@column_list', 'church'),
(549, -1062731746, 1453682245, 'admin@column_add', 'church'),
(550, -1062731746, 1453682246, 'channel@get_model', 'church'),
(551, -1062731746, 1453682246, 'column@get_column', 'church'),
(552, -1062731746, 1453682258, 'column@column_save', 'church'),
(553, -1062731746, 1453682260, 'column@get_column', 'church'),
(554, -1062731746, 1453682261, 'admin@column_list', 'church'),
(555, -1062731746, 1453682263, 'column@get_column', 'church'),
(556, -1062731746, 1453682263, 'channel@get_model', 'church'),
(557, -1062731746, 1453682267, 'admin@column_add', 'church'),
(558, -1062731746, 1453682269, 'channel@get_model', 'church'),
(559, -1062731746, 1453682269, 'column@get_specify_column', 'church'),
(560, -1062731746, 1453682269, 'column@get_column', 'church'),
(561, -1062731746, 1453682274, 'column@column_save', 'church'),
(562, -1062731746, 1453682276, 'column@get_column', 'church');
...
CREATE TABLE IF NOT EXISTS `zycms_piece` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='内容碎片表' AUTO_INCREMENT=4 ;
...
(1, '底部版权信息', '<p>底部版权信息底部版权信息</p>\n'),
(2, '首页about', '<p>首页about首页about首页about</p>\n'),
(3, '左侧联系我们', '<p>左侧联系我们左侧联系我们左侧联系我们左侧联系我们</p>\n');
...
--
-- 转存表中的数据 `zycms_products`
--

INSERT INTO `zycms_products` (`id`, `body`) VALUES
(1, '<p style="margin: 0px; padding: 3px 0px; text-indent: 27px; font-family: 宋体, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 25px;"><span style="margin: 0px; padding: 0px; font-family: ''Times New Roman'';">生活中，谁都有需要帮助的时候。想请人帮忙，该如何开口？下面来看几个简单的口语问句，相信不会有人拒绝给你帮助！</span></p>\n\n<p style="margin: 0px; padding: 3px 0px; text-indent: 27px; font-family: 宋体, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 25px;"><span style="margin: 0px; padding: 0px; font-family: ''Times New Roman'';">Can I bug you?</span></p>\n\n<p style="margin: 0px; padding: 3px 0px; text-indent: 27px; font-family: 宋体, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 25px;"><span style="margin: 0px; padding: 0px; font-family: ''Times New Roman'';">能打扰你一下吗？</span></p>\n\n<p style="margin: 0px; padding: 3px 0px; text-indent: 27px; font-family: 宋体, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 25px;"><span style="margin: 0px; padding: 0px; font-family: ''Times New Roman'';">Would you please do me a favor?</span></p>\n\n<p style="margin: 0px; padding: 3px 0px; text-indent: 27px; font-family: 宋体, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 25px;"><span style="margin: 0px; padding: 0px; font-family: ''Times New Roman'';">能请您帮我一个忙吗？</span></p>\n\n<p style="margin: 0px; padding: 3px 0px; text-indent: 27px; font-family: 宋体, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 25px;"><span style="margin: 0px; padding: 0px; font-family: ''Times New Roman'';">Give me a hand.</span></p>\n\n<p style="margin: 0px; padding: 3px 0px; text-indent: 27px; font-family: 宋体, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 25px;"><span style="margin: 0px; padding: 0px; font-family: ''Times New Roman'';">快搭把手！</span></p>\n\n<p style="margin: 0px; padding: 3px 0px; text-indent: 27px; font-family: 宋体, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 25px;"><span style="margin: 0px; padding: 0px; font-family: ''Times New Roman'';">I can&#39;t manage. Can you help?</span></p>\n\n<p style="margin: 0px; padding: 3px 0px; text-indent: 27px; font-family: 宋体, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 25px;"><span style="margin: 0px; padding: 0px; font-family: ''Times New Roman'';">我应付不了了。能帮下忙吗？</span></p>\n\n<p style="margin: 0px; padding: 3px 0px; text-indent: 27px; font-family: 宋体, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 25px;"><span style="margin: 0px; padding: 0px; font-family: ''Times New Roman'';">Could you spare a moment?</span></p>\n\n<p style="margin: 0px; padding: 3px 0px; text-indent: 27px; font-family: 宋体, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 25px;"><span style="margin: 0px; padding: 0px; font-family: ''Times New Roman'';">您有空吗？</span></p>\n\n<p style="margin: 0px; padding: 3px 0px; text-indent: 27px; font-family: 宋体, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 25px;"><span style="margin: 0px; padding: 0px; font-family: ''Times New Roman'';">I wonder if you could help me with this?</span></p>\n\n<p style="margin: 0px; padding: 3px 0px; text-indent: 27px; font-family: 宋体, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 25px;"><span style="margin: 0px; padding: 0px; font-family: ''Times New Roman'';">不知道能否请您帮我一下？</span></p>\n\n<p style="margin: 0px; padding: 3px 0px; text-indent: 27px; font-family: 宋体, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 25px;"><span style="margin: 0px; padding: 0px; font-family: ''Times New Roman'';">Would you please shut the door?</span></p>\n\n<p style="margin: 0px; padding: 3px 0px; text-indent: 27px; font-family: 宋体, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 25px;"><span style="margin: 0px; padding: 0px; font-family: ''Times New Roman'';">能请您把门关上吗？</span></p>\n\n<p style="margin: 0px; padding: 3px 0px; text-indent: 27px; font-family: 宋体, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 25px;"><span style="margin: 0px; padding: 0px; font-family: ''Times New Roman'';">I&#39;m afraid it was a bother for you to do this.</span></p>\n\n<p style="margin: 0px; padding: 3px 0px; text-indent: 27px; font-family: 宋体, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 25px;"><span style="margin: 0px; padding: 0px; font-family: ''Times New Roman'';">恐怕这件事要麻烦您了。</span></p>\n'),
(2, '<div class="para" style="font-size: 14px; word-wrap: break-word; margin-bottom: 15px; text-indent: 28px; line-height: 24px; zoom: 1; font-family: arial, 宋体, sans-serif;">计算机（computer）俗称电脑，是一种用于高速计算的电子计算机器，可以进行数值计算，又可以进行逻辑计算，还具有存储记忆功能。是能够按照程序运行，自动、高速处理海量数据的现代化智能电子设备。由硬件系统和软件系统所组成，没有安装任何软件的计算机称为裸机。可分为超级计算机、工业控制计算机、网络计算机、个人计算机、嵌入式计算机五类，较先进的计算机有<a href="http://baike.baidu.com/view/18639.htm" style="color: rgb(19, 110, 194); text-decoration: none;" target="_blank">生物计算机</a>、<a href="http://baike.baidu.com/view/104195.htm" style="color: rgb(19, 110, 194); text-decoration: none;" target="_blank">光子计算机</a>、<a href="http://baike.baidu.com/view/18645.htm" style="color: rgb(19, 110, 194); text-decoration: none;" target="_blank">量子计算机</a>等。</div>\n\n<div class="para" style="font-size: 14px; word-wrap: break-word; margin-bottom: 15px; text-indent: 28px; line-height: 24px; zoom: 1; font-family: arial, 宋体, sans-serif;">计算机发明者<a href="http://baike.baidu.com/view/54300.htm" style="color: rgb(19, 110, 194); text-decoration: none;" target="_blank">约翰&middot;冯&middot;诺依曼</a>。计算机是20世纪最先进的科学技术发明之一，对人类的生产活动和社会活动产生了极其重要的影响，并以强大的生命力飞速发展。它的应用领域从最初的军事科研应用扩展到社会的各个领域，已形成了规模巨大的计算机产业，带动了全球范围的技术进步，由此引发了深刻的社会变革，计算机已遍及一般学校、企事业单位，进入寻常百姓家，成为信息社会中必不可少的工具。</div>\n\n<div class="para" style="font-size: 14px; word-wrap: break-word; margin-bottom: 15px; text-indent: 28px; line-height: 24px; zoom: 1; font-family: arial, 宋体, sans-serif;">计算机的应用在中国越来越普遍，改革开放以后，中国计算机用户的数量不断攀升，应用水平不断提高，特别是互联网、通信、多媒体等领域的应用取得了不错的成绩。1996年至2009 年，计算机用户数量从原来的630万增长至6710 万台，联网计算机台数由原来的2.9万台上升至5940万台。互联网用户已经达到3.16 亿，无线互联网有6.7 亿移动用户，其中手机上网用户达1.17 亿，为全球第一位。</div>\n');
...
CREATE TABLE IF NOT EXISTS `zycms_rule` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='规则表' AUTO_INCREMENT=40 ;
...
(4, 1, 'products.html', 'products/index', 1),
(5, 1, 'products/1-page.html', 'products/category/1/page/12', 2),
(6, 1, 'products/aid.html', 'products/detail/aid', 3),
(7, 2, 'news.html', 'news/index', 1),
(8, 2, 'news/2-page.html', 'news/category/2/page/12', 2),
(9, 2, 'news/aid.html', 'news/detail/aid', 3),
(10, 3, 'about.html', 'about/index', 1),
(11, 3, 'about/3-page.html', 'about/category/3/page/12', 2),
(12, 3, 'about/aid.html', 'about/detail/aid', 3),
(13, 4, 'project.html', 'project/index', 1),
(14, 4, 'project/4-page.html', 'project/category/4/page/12', 2),
(15, 4, 'project/aid.html', 'project/detail/aid', 3),
(16, 5, 'chanpinyiji.html', 'chanpinyiji/index', 1),
(17, 5, 'chanpinyiji/5-page.html', 'products/category/5/page/12', 2),
(18, 5, 'chanpinyiji/aid.html', 'products/detail/aid', 3),
(19, 6, 'chanpinyiji2.html', 'chanpinyiji2/index', 1),
(20, 6, 'chanpinyiji2/6-page.html', 'products/category/6/page/12', 2),
(21, 6, 'chanpinyiji2/aid.html', 'products/detail/aid', 3),
(22, 7, 'xinwendongtai.html', 'xinwendongtai/index', 1),
(23, 7, 'xinwendongtai/7-page.html', 'news/category/7/page/12', 2),
(24, 7, 'xinwendongtai/aid.html', 'news/detail/aid', 3),
(25, 8, 'xingyezixun.html', 'xingyezixun/index', 1),
(26, 8, 'xingyezixun/8-page.html', 'news/category/8/page/12', 2),
(27, 8, 'xingyezixun/aid.html', 'news/detail/aid', 3),
(28, 9, 'changjianwenti.html', 'changjianwenti/index', 1),
(29, 9, 'changjianwenti/9-page.html', 'news/category/9/page/12', 2),
(30, 9, 'changjianwenti/aid.html', 'news/detail/aid', 3),
(35, 11, 'feedback.html', 'about/category/11', 2),
(37, 12, 'chanpin.html', 'chanpin/index', 1),
(38, 12, 'chanpin/12-page.html', 'products/category/12/page/12', 2),
(39, 12, 'chanpin/aid.html', 'products/detail/aid', 3);
...
CREATE TABLE IF NOT EXISTS `zycms_tongji` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='统计表' AUTO_INCREMENT=2 ;
...
(1, '谷歌浏览器', -1062731746, '2015-12-11', '直接访问');
...
CREATE TABLE IF NOT EXISTS `zycms_y_job` (
  `id` int(10) unsigned NOT NULL COMMENT 'ID',
  `zwbm` varchar(255) DEFAULT NULL COMMENT '职位部门',
  `gzdd` varchar(255) DEFAULT NULL COMMENT '工作地点',
  `zprs` varchar(255) DEFAULT NULL COMMENT '招聘人数',
  `zgze` text COMMENT '工作职责',
  `zwyq` text COMMENT '职位要求',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
INSERT INTO `zycms_y_job` (`id`, `zwbm`, `gzdd`, `zprs`, `zgze`, `zwyq`) VALUES
(5, '职位部门', '工作地点', '2', '<p>这是工作职责....</p>\n', '<p>只是职位要求...</p>\n');

-- --------------------------------------------------------

--
-- 表的结构 `zycms_y_message`
--

CREATE TABLE IF NOT EXISTS `zycms_y_message` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `name` varchar(255) DEFAULT NULL COMMENT '姓　　名',
  `unit` varchar(255) DEFAULT NULL COMMENT '留言单位',
  `address` varchar(255) DEFAULT NULL COMMENT '联系地址',
  `email` varchar(255) DEFAULT NULL COMMENT '电子邮件',
  `phone` varchar(255) DEFAULT NULL COMMENT '联系电话',
  `fax_number` varchar(255) DEFAULT NULL COMMENT '传真号码',
