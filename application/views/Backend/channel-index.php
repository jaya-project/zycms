      ...
      <tbody><tr>
        <td><table width="100%" class="contenttable" border="0" cellpadding="1" cellspacing="1">
			...
			<tr ng-repeat="d in data">
              ...
              <td><a ng-click="modifyModel(d.channel_id)" href="javascript:void(0)">修改</a> <a class="delete_button" ng-click="deleteModel(d.channel_id)" href="javascript:void(0)">删除</a></td>
            </tr>
  </tbody>
