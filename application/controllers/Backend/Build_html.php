	...
	public function build_single_detail($v = array())
	{
		...
		if ($total_pages >= $page) {
            ...
            foreach ($articles as $article) {
                ...
                $temp = $v;
                $title = $pinyin::getPinyin(substr($article['title'],0,20)).$article['id'];
                $temp['destination_rule'] = str_replace('aid', $title, $temp['destination_rule']);
                $temp['source_rule'] = str_replace('aid', $article['id'], $temp['source_rule']);
