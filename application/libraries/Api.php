...
class Api
{
	...
	public function __construct() {
		...
		$this->CI->load->model(array('column_model', 'flink_model', 'tongji_model', 'piece_model','archives_model', 'rule_model', 'keywords_model', 'channel_model'));
	...
	*/
...

	{
		...
		return $this->CI->tongji_model->count_all();
